        ...
        <TabsContent value="components" className="space-y-8">
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <ModernCard variant="gradient">
                ...
                <ModernCardFooter>
                  <GradientButton>دکمه</GradientButton>
                </ModernCardFooter>
              </ModernCard>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <GradientButton gradientType="secondary">گرادیانت ثانویه</GradientButton>
              <GradientButton gradientType="sunset">گرادیانت غروب</GradientButton>
              <GradientButton gradientType="ocean">گرادیانت اقیانوس</GradientButton>
            </div>
          </section>
