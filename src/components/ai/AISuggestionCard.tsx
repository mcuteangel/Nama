...
import { PlusCircle, UserCheck, Phone, Mail, Building, Briefcase, Link as LinkIcon, XCircle, Edit, Sparkles, Zap, Heart, ChevronDown, ChevronUp, CheckCircle } from "lucide-react";
