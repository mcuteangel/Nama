...
const formSchema = z.object({
  ...
  password: z.string().min(6, { message: "رمز عبور باید حداقل ۶ کاراکتر باشد." }).optional().or(z.literal("")),
  first_name: z.string().min(1, { message: "نام الزامی است." }).optional().or(z.literal("")),
  last_name: z.string().min(1, { message: "نام خانوادگی الزامی است." }).optional().or(z.literal("")),
