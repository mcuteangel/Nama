...
import { AccessibilityContext, AccessibilityContextType, FocusManager, AccessibilitySettings } from './AccessibilityContext';
...
export const AccessibilityProvider: React.FC<AccessibilityProviderProps> = ({
  ...
  const updateSettings = useCallback((newSettings: Partial<AccessibilitySettings>) => {
    setSettings((prev: AccessibilitySettings) => ({ ...prev, ...newSettings }));
  }, []);
