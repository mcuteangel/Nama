          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 sm:mb-6">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center shadow-lg">
                <Mail size={24} className="sm:w-8 text-white animate-pulse" />
              </div>
              <div>
                ...
                <p className="text-white/80 text-sm sm:text-base lg:text-lg">
                  آدرس ایمیل‌های مخاطب را اضافه کنید
                </p>
              </div>
            </div>
            ...
            {fields.map((item, index) => {
              ...
              return (
                <div key={item.id} className="group relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl sm:rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-300"></div>
